...
export const SideBar: React.FC<ISideBar> = ({ isOpen, onClose }) => {
  ...
  const className = {
    ...
    sideBarClass:
      "absolute slide-right h-screen flex flex-col bg-primary-foreground transition-all duration-300 ease-in-out data-[state=false]:opacity-0 data-[state=false]:translate-x-1/4 shadow-lg w-screen sm:w-96 py-8 px-4",
  };
